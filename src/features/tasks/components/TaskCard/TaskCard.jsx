...
const TaskCard = ({
  ...
  const handleOpenDetail = () => {
    if (!isMenuOpen && !deleteDialogOpen && !shareOpen) {
        ...
        <div className="flex items-center gap-2">
          ...
          {filteredSharedUsers.length > 0 ? (
            <div className="flex -space-x-2 overflow-hidden">
              <TooltipProvider>
                {filteredSharedUsers.slice(0, 4).map((collaborator, i) => (
                  <Tooltip key={i}>
                    <TooltipTrigger asChild>
                ...
                <div className="rounded-lg border border-gray-200 dark:border-gray-800 shadow-sm w-full max-w-md bg-white">
                  ...
                  <div className="px-4 py-3 border-t border-gray-100 dark:border-gray-800">
                    <div className="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
                      ...
                      <span>
                        Created on:{" "}
                        {new Date(create_at).toLocaleDateString("en-US", {
                          year: "numeric",
                          month: "long",
                          day: "numeric",
                        })}
