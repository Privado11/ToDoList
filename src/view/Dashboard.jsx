              ...
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Invita a nuevos colaboradores a tus proyectos
                    </DialogDescription>
                  </DialogHeader>
                  <Input
      ...
      case "calendar":
        return (
          <div className="space-y-4">
            ...
            <p>
              Aquí se mostraría un calendario con las fechas de vencimiento de
              las tareas.
            </p>
          </div>
        );
                    ...
                    <nav className="mt-4">
                      <ul className="space-y-2">
                        ...
                        <li>
                          <Button
                            variant={
                              activeSection === "friends" ? "default" : "ghost"
                            }
                            className="w-full justify-start"
                            onClick={() => {
                        ...
                        <li>
                          <Button
                            variant={
                              activeSection === "messages" ? "default" : "ghost"
                            }
                            className="w-full justify-start"
                            onClick={() => {
                        ...
                        <li>
                          <Button
                            variant={
                              activeSection === "calendar" ? "default" : "ghost"
                            }
                            className="w-full justify-start"
                            onClick={() => {
